...
{
	int **input_image;
        FILE *file1 = fopen("licence_plate1.pgm", "r"); // input file read
	...
	static int distance[15]; // hamming distance
	...
	printf("Result : ");
		...
		// hamming distance
				...
				if(abs(result2[y][x] - H_0[y][x]) == 255) distance[10]++;
                                if(abs(result2[y][x] - H_1[y][x]) == 255) distance[11]++;
                                if(abs(result2[y][x] - H_2[y][x]) == 255) distance[12]++;
                                if(abs(result2[y][x] - H_3[y][x]) == 255) distance[13]++;
                                if(abs(result2[y][x] - H_4[y][x]) == 255) distance[14]++;
		...
		if(class == 0) printf("0");
                else if(class == 12) printf("소");
                else if(class == 13) printf("나");
